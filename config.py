...
ADMINS = (
    [int(i.strip()) for i in os.environ.get("ADMINS", "2070212844").split(",")]
...
OWNER_ID = int(os.environ.get("OWNER_ID", "2070212844"))  # id of the owner
...
UPDATE_CHANNEL = int(os.environ.get(
    "UPDATE_CHANNEL", "-1002188377812"))  # For Force Subscription
